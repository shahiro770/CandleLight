...
* 
* The CustomInputModule class is used to prevent mouse inputs from deselecting selectable
* objects. This is done to make sure the game is playable via mouse or keyboard at any time.
*
* Code is modified version of the normal InputModule script.
*
*/
...
namespace UnityEngine.EventSystems {
    ...
    public class CustomInputModule : PointerInputModule {
        ...
        public override bool IsModuleSupported() {
            ...
            // to use CustomInputModule for non-touch input events.
