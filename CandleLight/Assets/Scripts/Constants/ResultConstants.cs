...
namespace Constants {
    ...
    public static class ResultConstants {
        ...
        public const string SUBAREAANDCOMBAT = "subAreaAndCombat";            /// <value> Move to new subArea, immediately fight specific monsters </value>
        public const string SUBAREAANDCOMBATANDSUBAREA = "subAreaAndCombatAndSubArea";    /// <value> Move to new subArea, immediately fight specific monsters, and then move to another subArea on clearing </value>
