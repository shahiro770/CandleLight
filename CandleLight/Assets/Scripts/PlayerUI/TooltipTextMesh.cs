...
* Date: June 18, 2019
* 
* The TooltipTextMesh is a tooltip that uses TextMeshPROUGUI instead of images
* to decide positioning. Main purpose is to avoid checking between images/textMeshProUGUIs
* in tooltips, especially when the tooltip is on everything and the TextMeshProUGUI is rare
*
*/
...
namespace PlayerUI {
    ...
    public class TooltipTextMesh : MonoBehaviour {
        ...
        public TextMeshProUGUI imageDisplayBackground; /// <value> Largest image around the image that when hovered, will display the tooltip </value>
